...
class Formulas:
    def __init__(self):
        ...
        print
        "Finished initiating Calculations module..."
    ...
    def object_displaced_volume(self, radius, volume, displaced_height):  # Fortrængt volume
        displaced_volume = self.pi * math.pow(displaced_height, 2) * (1.0 / 3) * (
                    (3 * radius) - displaced_height)  # m^3
    ...
    def object_volume_sphere(self, radius=None, density=None, mass=None):  # Kugle volume
        if radius != None:
            ...
            print
            "Invalid parameters return 0.5 cubic meters"
            return 0.5
        return volume
    ...
    def drag_equation(self, speed, displaced_height, displaced_volume, radius, volume, user_densityFluid,
                      user_densityAir):  # Modvirkende kraft fra væske
