...
class Methods():
    def __init__(self):
        self.changes = True
        self.dictionary = {"mass": 350, "radius": 0, "volume": 0.524, "density": 667.93893, "fluid density": 1000,
                           "air density": 1.29, "scale": 200, "time": 1.0}
        self.err_getSettings = "Not possible to get settings. Try to save new settings."
        print
        "Finished initiating Features module..."
    ...
    def monitor_changes(self, changes=None, initiative=False):
        if changes is None:
            ...
            for change in changes:
                if 'scale' in changes:
                    print
                    "Re-evaluating:", changes[change], "to", change
                    ...
                    self.dictionary[change] *= changes[change]
                    print
                    "Re-evaluating:", (changes[change] - 1) * 100, "% to", change
                    ...
                    print
                    "Re-evaluating:", change, "equal to", 0.005
                    print
            ...
            for change in changes:
                self.dictionary[change] = changes[change]
                print
                "Performing change:", change, changes[change]
