...
{% block favicon %}
    <link id="favicon" rel="shortcut icon" type="image/x-icon"
          href="{{ static_url("base/images/favicon-notebook.ico") }}">{% endblock %}

{% block stylesheet %}

    {% if mathjax_url %}
        <script type="text/javascript" src="{{ mathjax_url }}?config={{ mathjax_config }}&delayStartupUntil=configured"
    ...
    <link rel="stylesheet" href="{{ static_url("components/bootstrap-tour/build/css/bootstrap-tour.min.css") }}"
          type="text/css"/>
...
{% block headercontainer %}
  ...
  {% block kernel_logo_widget %}
      <img class="current_kernel_logo" alt="Current Kernel Logo"
            ...
            <div id="menus" class="navbar navbar-default" role="navigation">
                <div class="container-fluid">
                    ...
                    <i id="readonly-indicator" class="navbar-text"
                       title='{% trans %}This notebook is read-only{% endtrans %}'>
                <span class="fa-stack">
                    ...
                    <div class="navbar-collapse collapse">
                        <ul class="nav navbar-nav">
                            <li class="dropdown"><a href="#" class="dropdown-toggle" data-toggle="dropdown">{% trans %}
                                File{% endtrans %}</a>
                                <ul id="file_menu" class="dropdown-menu">
                                    ...
                                    <li id="save_checkpoint"><a href="#">{% trans %}Save and
                                        Checkpoint{% endtrans %}</a></li>
                                    <!-- <hr/> -->
                                    <li class="divider"></li>
                                    <li id="restore_checkpoint" class="dropdown-submenu"><a href="#">{% trans %}Revert
                                        to Checkpoint{% endtrans %}</a>
                                    ...
                                    <li class="dropdown-submenu"><a href="#">{% trans %}Download as{% endtrans %}</a>
                                        <ul id="download_menu" class="dropdown-menu">
                                            <li id="download_ipynb"><a href="#">{% trans %}Notebook
                                                (.ipynb){% endtrans %}</a></li>
                                            <li id="download_script"><a href="#">{% trans %}Script{% endtrans %}</a>
                                            </li>
                                            <li id="download_html"><a href="#">{% trans %}HTML (.html){% endtrans %}</a>
                                            </li>
                                            <li id="download_slides"><a href="#">{% trans %}Reveal.js slides
                                                (.html){% endtrans %}</a></li>
                                            <li id="download_markdown"><a href="#">{% trans %}Markdown
                                                (.md){% endtrans %}</a></li>
                                            <li id="download_rst"><a href="#">{% trans %}reST (.rst){% endtrans %}</a>
                                            </li>
                                            <li id="download_latex"><a href="#">{% trans %}LaTeX
                                                (.tex){% endtrans %}</a></li>
                                            <li id="download_pdf"><a href="#">{% trans %}PDF via LaTeX
                                                (.pdf){% endtrans %}</a></li>
                                    ...
                                    <li class="dropdown-submenu hidden"><a href="#">{% trans %}Deploy
                                        as{% endtrans %}</a>
                            ...
                            <li class="dropdown"><a href="#" class="dropdown-toggle" data-toggle="dropdown">{% trans %}
                                ...
                                <ul id="edit_menu" class="dropdown-menu">
                                    ...
                                    <li id="paste_cell_above" class="disabled"><a href="#">{% trans %}Paste Cells
                                        Above{% endtrans %}</a></li>
                                    <li id="paste_cell_below" class="disabled"><a href="#">{% trans %}Paste Cells
                                        Below{% endtrans %}</a></li>
                                    <li id="paste_cell_replace" class="disabled"><a href="#">{% trans %}Paste Cells
                                        &amp; Replace{% endtrans %}</a></li>
                                    <li id="delete_cell"><a href="#">{% trans %}Delete Cells{% endtrans %}</a></li>
                                    <li id="undelete_cell" class="disabled"><a href="#">{% trans %}Undo Delete
                                        Cells{% endtrans %}</a></li>
                                    <li class="divider"></li>
                                    <li id="split_cell"><a href="#">{% trans %}Split Cell{% endtrans %}</a></li>
                                    <li id="merge_cell_above"><a href="#">{% trans %}Merge Cell Above{% endtrans %}</a>
                                    </li>
                                    <li id="merge_cell_below"><a href="#">{% trans %}Merge Cell Below{% endtrans %}</a>
                                    </li>
                                    <li class="divider"></li>
                                    <li id="move_cell_up"><a href="#">{% trans %}Move Cell Up{% endtrans %}</a></li>
                                    <li id="move_cell_down"><a href="#">{% trans %}Move Cell Down{% endtrans %}</a></li>
                                    <li class="divider"></li>
                                    <li id="edit_nb_metadata"><a href="#">{% trans %}Edit Notebook
                                        Metadata{% endtrans %}</a></li>
                                    <li class="divider"></li>
                                    <li id="find_and_replace"><a href="#"> {% trans %}Find and
                                        Replace{% endtrans %} </a></li>
                                    <li class="divider"></li>
                                    <li id="cut_cell_attachments"><a href="#">{% trans %}Cut Cell
                                        Attachments{% endtrans %}</a></li>
                                    <li id="copy_cell_attachments"><a href="#">{% trans %}Copy Cell
                                        Attachments{% endtrans %}</a></li>
                                    <li id="paste_cell_attachments" class="disabled"><a href="#">{% trans %}Paste Cell
                                        Attachments{% endtrans %}</a></li>
                                    <li class="divider"></li>
                                    <li id="insert_image" class="disabled"><a href="#"> {% trans %}Insert
                                        Image{% endtrans %} </a></li>
                                </ul>
                            </li>
                            <li class="dropdown"><a href="#" class="dropdown-toggle" data-toggle="dropdown">{% trans %}
                            ...
                            <li class="dropdown"><a href="#" class="dropdown-toggle" data-toggle="dropdown">{% trans %}
                                ...
                                <ul id="cell_menu" class="dropdown-menu">
                                    <li id="run_cell"
                                        title="{% trans %}Run this cell, and move cursor to the next one{% endtrans %}">
                                        <a href="#">{% trans %}Run Cells{% endtrans %}</a></li>
                                    <li id="run_cell_select_below"
                                        title="{% trans %}Run this cell, select below{% endtrans %}">
                                        <a href="#">{% trans %}Run Cells and Select Below{% endtrans %}</a></li>
                                    <li id="run_cell_insert_below"
                                        title="{% trans %}Run this cell, insert below{% endtrans %}">
                                        <a href="#">{% trans %}Run Cells and Insert Below{% endtrans %}</a></li>
                                    <li id="run_all_cells"
                                        title="{% trans %}Run all cells in the notebook{% endtrans %}">
                                        <a href="#">{% trans %}Run All{% endtrans %}</a></li>
                                    <li id="run_all_cells_above"
                                        title="{% trans %}Run all cells above (but not including) this cell{% endtrans %}">
                                        <a href="#">{% trans %}Run All Above{% endtrans %}</a></li>
                                    <li id="run_all_cells_below"
                                        title="{% trans %}Run this cell and all cells below it{% endtrans %}">
                                    ...
                                    <li class="divider"></li>
                                    <li id="current_outputs" class="dropdown-submenu"><a href="#">{% trans %}Current
                                        Outputs{% endtrans %}</a>
                                        <ul class="dropdown-menu">
                                    ...
                                    <li id="all_outputs" class="dropdown-submenu"><a href="#">{% trans %}All
                                        Output{% endtrans %}</a>
                                        <ul class="dropdown-menu">
                            ...
                            <li class="dropdown"><a href="#" class="dropdown-toggle" data-toggle="dropdown">{% trans %}
                                ...
                                <ul id="help_menu" class="dropdown-menu">
                                    {% block help %}
                                        <li id="notebook_tour"
                                            title="{% trans %}A quick tour of the notebook user interface{% endtrans %}">
                                            <a href="#">{% trans %}User Interface Tour{% endtrans %}</a></li>
                                        <li id="keyboard_shortcuts"
                                            title="{% trans %}Opens a tooltip with all keyboard shortcuts{% endtrans %}">
                                            <a href="#">{% trans %}Keyboard Shortcuts{% endtrans %}</a></li>
                                        <li id="edit_keyboard_shortcuts"
                                            title="{% trans %}Opens a dialog allowing you to edit Keyboard shortcuts{% endtrans %}">
                                            <a href="#">{% trans %}Edit Keyboard Shortcuts{% endtrans %}</a></li>
                                        <li class="divider"></li>
                                        {% set
                            sections = (
                                (
                                    ...
                                    ("https://help.github.com/articles/markdown-basics/",_("Markdown"),True),
                                        ...
                                        {% for helplinks in sections %}
                                            {% for link in helplinks %}
                                                <li><a rel="noreferrer" href="{{ link[0] }}"
                                                       target="{{ '_blank' if link[2] }}"
                                                       title="{{ openmsg if link[2] }}">
                                                    {% if link[2] %}
                                        ...
                                        {% endfor %}
                                        <li class="divider"></li>
                                        <li title="{% trans %}About Jupyter Notebook{% endtrans %}"><a
                                                id="notebook_about" href="#">{% trans %}About{% endtrans %}</a></li>
                                    {% endblock %}
                                </ul>
                            </li>
                        </ul>
