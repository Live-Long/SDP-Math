...
{% block favicon %}
    <link id="favicon" rel="shortcut icon" type="image/x-icon"
          href="{{ static_url("base/images/favicon-file.ico") }}">{% endblock %}
                        ...
                        <ul class="nav navbar-nav">
                            ...
                            <li class="dropdown"><a href="#" class="dropdown-toggle" data-toggle="dropdown">{% trans %}
                                ...
                                <ul id="edit-menu" class="dropdown-menu">
                                    ...
                                    <li id="menu-replace"><a href="#">{% trans %}Find &amp; Replace{% endtrans %}</a>
                                    </li>
                                    <li class="divider"></li>
                                    <li class="dropdown-header">{% trans %}Key Map{% endtrans %}</li>
                                    <li id="menu-keymap-default"><a href="#">{% trans %}Default{% endtrans %}<i
                                            class="fa"></i></a></li>
                                    <li id="menu-keymap-sublime"><a href="#">{% trans %}Sublime Text{% endtrans %}<i
                                            class="fa"></i></a></li>
                            ...
                            <li class="dropdown"><a href="#" class="dropdown-toggle" data-toggle="dropdown">{% trans %}
                                ...
                                <ul id="view-menu" class="dropdown-menu">
                                    ...
                                    <li id="menu-line-numbers"><a href="#">{% trans %}Toggle Line
                                        Numbers{% endtrans %}</a></li>
                                </ul>
                            </li>
                            <li class="dropdown"><a href="#" class="dropdown-toggle" data-toggle="dropdown">{% trans %}
                                Language{% endtrans %}</a>
