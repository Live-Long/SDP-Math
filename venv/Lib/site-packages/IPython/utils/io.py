...
def atomic_writing(*args, **kwargs):
    ...
    warn("IPython.utils.io.atomic_writing has moved to notebook.services.contents.fileio since IPython 4.0",
         DeprecationWarning, stacklevel=2)
...
def unicode_std_stream(stream='stdout'):
    ...
    warn("IPython.utils.io.unicode_std_stream has moved to nbconvert.utils.io since IPython 4.0", DeprecationWarning,
         stacklevel=2)
